...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README.md", "Rakefile", "bin/couchdb_view_server", "couchdb-ruby.gemspec", "lib/couch_db.rb", "lib/couch_db/design.rb", "lib/couch_db/sandbox.rb", "lib/couch_db/templates.rb", "lib/couch_db/view.rb", "test/design_doc_test.rb", "test/filter_test.rb", "test/list_test.rb", "test/sandbox_test.rb", "test/show_test.rb", "test/test_helper.rb", "test/update_test.rb", "test/validation_test.rb", "test/view_test.rb"]
